...
class ColumnMappingInsertTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->connection->shouldReceive('getName')
            ->andReturn('snowflake_api');
    }
    
    /**
     * Test column determination with explicit columns
     */
    public function testDetermineColumnsWithExplicitColumns()
    {
     ...
     */
    public function testDetermineColumnsWithAssociativeArray()
    {
     ...
     */
    public function testDetermineColumnsWithNumericArray()
    {
        // Set up a query without explicit columns
        $query = new Builder($this->connection);
        $query->from = 'test_table';
     ...
     */
    public function testCompileInsertWithExplicitColumns()
    {
        // Set up a query with explicit columns
        $query = new Builder($this->connection);
        $query->from = 'test_table';
