...
class SchemaGrammar extends Grammar
{
     ...
     */
    public function compileRenameColumn(Blueprint $blueprint, Fluent $command, $connection = null)
    {
     ...
     * @throws \RuntimeException
     */
    public function compileChange(Blueprint $blueprint, Fluent $command, $connection = null): array|string
    {
        $table = $this->wrapTable($blueprint);
        $changes = [];
