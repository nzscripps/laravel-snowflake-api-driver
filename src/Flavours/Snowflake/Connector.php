...
use Closure;
use Exception;
use LaravelSnowflakeApi\Contracts\OdbcDriver;
use LaravelSnowflakeApi\ODBCConnector;
use PDO;
...
class Connector extends ODBCConnector implements OdbcDriver
{
    ...
    public function connect(array $config)
    {
        ...
        if (PHP_VERSION_ID > 80000) {
            $connection->setAttribute(PDO::ATTR_STATEMENT_CLASS, [\LaravelSnowflakeApi\Flavours\Snowflake\PDO\Statement80::class, [$connection]]);
        } else {
            $connection->setAttribute(PDO::ATTR_STATEMENT_CLASS, [\LaravelSnowflakeApi\Flavours\Snowflake\PDO\Statement74::class, [$connection]]);
        }
